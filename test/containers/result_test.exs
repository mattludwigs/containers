defmodule Containers.ResultTest do
  ...
  test "implements Mappable protocol", %{ok_result: ok_result, error_result: error_result, ok_value_result: ok_vr, error_value_result: error_vr} do
    ...
    assert %Containers.Result{value: :ok} = Containers.map(ok_vr, fn(does_not_matter) -> does_not_matter + 1 end)
